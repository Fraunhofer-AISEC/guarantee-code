#!/bin/bash
printf "Learn all possible control flows:\n"
...
printf "Done\n"
printf "Send signing request 3... "
curl -k -X POST -d 'hash=53c234e5e8472b6ac51c1ae1cab3fe06fad05' https://localhost:4433/wrong_signature.html >& /dev/null
printf "Done\n"
printf "Send signing request 4... "
curl -k -X POST -d 'hash=7de1555df0c2700329e815b93b32c571c3ea54dc967b89e81ab73b9972b72d1d' https://localhost:4433/wrong_signature.html >& /dev/null
printf "Done\n"
