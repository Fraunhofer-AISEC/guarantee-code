...
#Compiler_Warnings := -Wno-discarded-qualifiers -Wall -Wextra -Wwrite-strings -Wlogical-op -Wshadow -Werror
...
#Common_C_Cpp_Flags := $(SGX_COMMON_CFLAGS) -fvisibility=hidden -fpie -fstack-protector $(Wolfssl_Include_Paths) -fno-builtin-printf -I.
